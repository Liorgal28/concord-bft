...
class ConcordClientPool {
 ...
 private:
  void setUpClientParams(bftEngine::SimpleClientParams& client_params,
                         const concord::config_pool::ConcordClientConfiguration& config_struct);

  void CreatePool(concord::config_pool::ConcordClientConfiguration& config_struct);
  ...
  struct ClientPoolMetrics {
    concordMetrics::CounterHandle requests_counter_;
    concordMetrics::CounterHandle executed_requests_counter_;
    concordMetrics::CounterHandle rejected_counter_;
    concordMetrics::CounterHandle full_batch_counter_;
    concordMetrics::CounterHandle partial_batch_counter_;
    concordMetrics::CounterHandle first_leg_counter_;
    concordMetrics::CounterHandle second_leg_counter_;
    concordMetrics::GaugeHandle size_of_batch_gauge_;
    concordMetrics::GaugeHandle clients_gauge_;
    concordMetrics::GaugeHandle last_request_time_gauge_;
  } ClientPoolMetrics_;
};
