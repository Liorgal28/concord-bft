...
struct CommConfig {
  ...
  std::unordered_map<bft::communication::NodeNum, bft::communication::NodeInfo> roNodes;
...
class ConcordClient {
 public:
  ...
  // Constructs the client by passing concord client configuration struct
  ...
  ConcordClient(int client_id,
                config_pool::ConcordClientConfiguration& struct_config,
  ...
  static std::unique_ptr<bft::communication::ICommunication> ToCommunication(
      const CommConfig& comm_config, config_pool::ConcordClientConfiguration& config_struct);
 ...
 private:
  void CreateClient(concord::config_pool::ConcordClientConfiguration& config_struct,
                    const bftEngine::SimpleClientParams& client_params);

  void CreateCommConfig(CommConfig& comm_config,
                        int num_replicas,
                        const config_pool::ConcordClientConfiguration& config_struct) const;
